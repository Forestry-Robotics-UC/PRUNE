...
def build_projector_params(node: Any) -> LidarProjectorParams:
    return LidarProjectorParams(
        ...
        use_geometric_gate=bool(node.use_geometric_gate),
        projection_geometric_enable=bool(node.projection_geometric_enable),
        geometric_k_neighbors=int(node.geometric_k_neighbors),
        geometric_radius_m=float(node.geometric_radius_m),
        geometric_min_neighbors=int(node.geometric_min_neighbors),
        geometric_curvature_max=float(node.geometric_curvature_max),
        ...
        adaptive_confidence_threshold_offset=float(node.adaptive_confidence_threshold_offset),
        adaptive_depth_edge_threshold_scale=float(node.adaptive_depth_edge_threshold_scale),
        adaptive_prefer_suppression_on_bad_health=bool(node.adaptive_prefer_suppression_on_bad_health),
