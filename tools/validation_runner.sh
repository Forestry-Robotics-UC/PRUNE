...
python3 -c "import sys; sys.path.insert(0, '/home/ros/ws/src/prune'); from tools.validation.validate_bag_workflow import capture_bag_topics; topics = capture_bag_topics('$BAG_PATH'); [print(t) for t in topics]" > "$OUTPUT_DIR/topics.txt" 2>&1 || true
